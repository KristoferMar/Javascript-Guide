class UI {
    constructor(){
        ...
        this.feelsLike = document.getElementById('w-leels-like');
    ...
    paint(weather) {
        ...
        this.string.textContent = weather.temprerature_string;
        ...
        this.wind.textContent = `Wind strength: ${weather.wind_string}`;
    }
}